    ...
    <>
      ...
      <div className="px-4 py-3 mx-3 mb-2 bg-muted rounded-lg flex items-center gap-3 border border-primary/20">
        ...
        <div className="min-w-0">
          <p className="text-xs font-bold text-foreground truncate">João Silva</p>
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center gap-3">
          <span className="w-8 h-8 rounded-full bg-accent flex items-center justify-center text-xs font-bold text-muted-foreground">JS</span>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-foreground truncate">João S.</p>
